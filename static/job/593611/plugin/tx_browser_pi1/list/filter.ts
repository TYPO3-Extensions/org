          ...
          tx_org_headquarters {
            ...
            title {
              ...
              first_item {
                cObject {
                  20 {
                    data = LLL:EXT:org/tca/locallang/tx_org_headquarters.xml:tx_org_headquarters.title
                  }
                }
              }
                // #43641, dwildt, 1-, 1+
          ...
          tx_org_jobcat {
            ...
            title {
              ...
              first_item {
                cObject {
                  20 {
                    data = LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobcat.title
                  }
                }
              }
                // #43641, dwildt, 1-, 1+
          ...
          tx_org_jobsector {
            ...
            title {
              ...
              first_item {
                cObject {
                  20 {
                    data = LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobsector.title
                  }
                }
              }
                // #43641, dwildt, 1-, 1+
