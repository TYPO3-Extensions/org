...
switch (true)
{
  case($llStatic == 'de'):
    ...
    $TCA['pages']['columns']['module']['config']['items'][] = array('Org: Personal', 'org_staff', t3lib_extMgm::extRelPath($_EXTKEY) . 'ext_icon/staff.gif');
  ...
  default:
    ...
    $TCA['pages']['columns']['module']['config']['items'][] = array('Org: Staff', 'org_staff', t3lib_extMgm::extRelPath($_EXTKEY) . 'ext_icon/staff.gif');
}
// Case $llStatic
//  #34858, 120320, dwildt
