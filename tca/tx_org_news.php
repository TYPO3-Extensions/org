  ...
  'columns' => array(
    ...
    'type' => array(
      ...
      'config' => array(
        ...
        'items' => array(
          'news' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.type.news',
            '1' => 'news',
            '2' => 'EXT:org/ext_icon/news.gif',
          ),
          'newspage' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.type.newspage',
            '1' => 'newspage',
            '2' => 'EXT:org/ext_icon/newspage.gif',
          ),
          'newsurl' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.type.newsurl',
            '1' => 'newsurl',
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    ...
    'newspage' => array('showitem' =>
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_news,       type,title;;;;1-1-1,subtitle,' .
      '--palette--;LLL:EXT:cms/locallang_ttc.xml:date;datetime_archivedate,' .
      'tx_org_newscat,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_newspage,   newspage,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_teaser,     teaser_title;;;;6-6-6, teaser_subtitle, teaser_short,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_marginal,   marginal_title;;;;6-6-6, marginal_subtitle, marginal_short,' .
      '--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.images,' .
      '--palette--;LLL:EXT:cms/locallang_ttc.xml:palette.imagefiles;imagefiles,' .
      '--palette--;LLL:EXT:org/locallang_db.xml:palette.image_accessibility;image_accessibility,' .
      '--palette--;LLL:EXT:cms/locallang_ttc.xml:palette.imageblock;imageblock,' .
    ...
    'newsurl' => array('showitem' =>
      ...
      '--palette--;LLL:EXT:cms/locallang_ttc.xml:date;datetime_archivedate,' .
      'tx_org_newscat,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_newsurl,    newsurl,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_teaser,     teaser_title;;;;6-6-6, teaser_subtitle, teaser_short,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_news.xml:tx_org_news.div_marginal,   marginal_title;;;;6-6-6, marginal_subtitle, marginal_short,' .
      '--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.images,' .
      '--palette--;LLL:EXT:cms/locallang_ttc.xml:palette.imagefiles;imagefiles,' .
