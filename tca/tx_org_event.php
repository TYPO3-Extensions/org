...
$TCA['tx_org_event'] = array(
  ...
  'columns' => array(
    ...
    'title' => array(
      ...
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.title',
      'config' => $conf_input_30_trimRequired,
    ),
    'subtitle' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.subtitle',
      'config' => $conf_input_30_trim,
    ),
    'length' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.length',
      'config' => $conf_input_30_trim,
    ),
    'bodytext' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.bodytext',
      'config' => $conf_text_rte,
    ),
    'teaser_title' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.teaser_title',
      'config' => $conf_input_30_trim,
    ),
    'teaser_subtitle' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.teaser_subtitle',
      'config' => $conf_input_30_trim,
    ),
    'teaser_short' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.teaser_short',
      'config' => $conf_text_50_10,
    ),
    'tx_org_eventcat' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.tx_org_eventcat',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:wizard.tx_org_eventcat.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:wizard.tx_org_eventcat.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_eventcat',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:wizard.tx_org_eventcat.edit',
    ...
    'tx_org_cal' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.tx_org_cal',
      'config' => array(
        'type' => 'select',
        'size' => $size_calendar,
        'minitems' => 0,
...
//      'l10n_mode' => 'exclude',
    ...
    'tx_org_headquarters' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.tx_org_headquarters',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_staff' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.tx_org_staff',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    '0' => array('showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_event,'
      . '  title;;;;1-1-1,subtitle,producer,length,bodytext;;;richtext[]:rte_transform[mode=ts];,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_teaser,'
      . '  teaser_title,teaser_subtitle,teaser_short,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_eventcat,'
      . '  tx_org_eventcat,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_calendar,'
      . '  tx_org_cal,'
      ...
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_headquarters,'
      . '  tx_org_headquarters,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_staff,'
      . '  tx_org_staff,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_event.div_embedded,'
      . '  embeddedcode,print,printcaption,printseo,'
...
$TCA['tx_org_eventcat'] = array(
  ...
  'columns' => array(
    ...
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_eventcat.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required,trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_eventcat.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
  ...
  'types' => array(
    '0' => array(
      'showitem' =>
      '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_eventcat.div_category, title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_event.xml:tx_org_eventcat.div_control, hidden'
      . ''
    ),
  ),
  'palettes' => array(
