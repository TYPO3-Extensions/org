...
//      'l10n_mode' => 'exclude',
    ...
    'name_first' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.name_first',
      'l10n_mode' => 'prefixLangTitle',
      'config' => array(
        'type' => 'input',
        'size' => '30',
    ...
    'name_last' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.name_last',
      'l10n_mode' => 'prefixLangTitle',
      'config' => array(
        'type' => 'input',
        'size' => '30',
    ...
    'birthday' => array(
      'exclude' => 1,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.birthday',
      'config' => array(
        'type' => 'input',
        'size' => '8',
        'max' => '20',
...
//        )
    ...
    'gender' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.gender',
      'config' => array(
        'type' => 'select',
        'items' => array(
          'unknown' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.gender_unknown',
            '1' => '',
          ),
          'male' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.gender_male',
            '1' => 'male',
          ),
          'female' => array(
            '0' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.gender_female',
            '1' => 'female',
          ),
        ),
        'default' => '',
    ...
    'bodytext' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.bodytext',
      'config' => array(
        'type' => 'text',
        'cols' => '30',
        'rows' => '5',
        'wizards' => array(
          ...
          'RTE' => array(
            ...
            'RTEonly' => 1,
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:wizard.rte.fullscreen',
    ...
    'tx_org_staffgroup' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_staffgroup',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'foreign_table_where' => 'AND tx_org_staffgroup.pid=###CURRENT_PID### AND tx_org_staffgroup.deleted = 0 AND tx_org_staffgroup.hidden = 0 ORDER BY tx_org_staffgroup.title',
        'form_type' => 'user',
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:wizard.tx_org_staffgroup.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:wizard.tx_org_staffgroup.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_staffgroup',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:wizard.tx_org_staffgroup.edit',
    ...
    'contact_email' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.contact_email',
      'exclude' => $bool_exclude_default,
      'config' => $conf_input_30_trim,
    ),
    'contact_fax' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.contact_fax',
      'exclude' => $bool_exclude_default,
      'config' => $conf_input_30_trim,
    ),
    'contact_phone' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.contact_phone',
      'exclude' => $bool_exclude_default,
      'config' => $conf_input_30_trim,
    ),
    'contact_skype' => array(
...
//      'l10n_mode' => 'exclude',
    ...
    'tx_org_downloads' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_downloads',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_headquarters' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_headquarters',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_job' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_job',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_service' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_service',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_news' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_news',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_event' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_event',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_location' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.tx_org_location',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
  ...
  'types' => array(
    ...
    'record' => array(
      ...
      . '  tx_org_service,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.div_news, '
      . '  tx_org_news,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.div_event, '
      . '  tx_org_event,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.div_location, '
      . '  tx_org_location,'
  ...
  'palettes' => array(
    'birthday' => array(
      'showitem' => ''
      . 'birthday;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.birthday,'
      . 'gender;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.gender'
      ,
      'canNotCollapse' => 1,
    ),
    'control' => array(
    ...
    'name' => array(
      'showitem' => ''
      . 'title;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.title, --linebreak--,'
      . 'name_first;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.name_first,'
      . 'name_last;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staff.name_last'
      ,
      'canNotCollapse' => 1,
    ),
    'typepage' => array(
...
$TCA[ 'tx_org_staffgroup' ] = array(
  ...
  'columns' => array(
    ...
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staffgroup.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required,trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staffgroup.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
  ...
  'types' => array(
    '0' => array(
      'showitem' =>
      '--div--;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staffgroup.div_category, title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_staff.xml:tx_org_staffgroup.div_control, hidden'
      . ''
    ),
  ),
  'palettes' => array(
