...
//      'l10n_mode' => 'exclude',
    ...
    'title' => array(
      ...
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.title',
      'config' => $conf_input_30_trimRequired,
    ),
    'url' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.url',
      'exclude' => $bool_exclude_default,
    ...
    'mail_address' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_address',
      'config' => $conf_text_30_05,
    ),
    'mail_street' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_street',
      'config' => array(
        'type' => 'input',
        'size' => '60',
        'eval' => 'trim'
    ...
    'mail_postcode' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_postcode',
      'config' => $conf_input_30_trim,
    ),
    'mail_city' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_city',
      'config' => $conf_input_30,
    ),
    'mail_country' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_country',
      'config' => $conf_input_30,
    ),
    'mail_lat' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_lat',
      'config' => $conf_input_30,
    ),
    'mail_lon' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_lon',
      'config' => $conf_input_30,
    ),
    'mail_url' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_url',
      'config' => $arr_wizard_url,
    ),
    'mail_embeddedcode' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_embeddedcode',
    ...
    'telephone' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.telephone',
      'config' => $conf_input_30_trim,
    ),
    'ticket_telephone' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.ticket_telephone',
      'config' => $conf_input_30_trim,
    ),
    'ticket_url' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.ticket_url',
      'config' => $arr_wizard_url,
    ),
    'fax' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.fax',
      'config' => $conf_input_30_trim,
    ),
    'email' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.email',
      'config' => $conf_input_30_trim,
    ),
    'tx_org_cal' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.tx_org_cal',
      'config' => array(
        'type' => 'select',
        'size' => $size_calendar,
        'minitems' => 0,
    ...
    'tx_org_headquarters' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.tx_org_headquarters',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_staff' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.tx_org_staff',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'pubtrans_stop' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.pubtrans_stop',
      'config' => $conf_text_rte,
    ),
    'pubtrans_url' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.pubtrans_url',
      'config' => $arr_wizard_url,
    ),
    'pubtrans_embeddedcode' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.pubtrans_embeddedcode',
      'config' => $conf_text_50_10,
    ),
    'citymap_url' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.citymap_url',
      'config' => $arr_wizard_url,
    ),
    'citymap_embeddedcode' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.citymap_embeddedcode',
      'config' => $conf_text_30_05,
    ),
    'image' => array(
      'exclude' => $bool_exclude_default,
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    ...
    'record' => array('showitem' => ''
      ...
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.div_contact,'
      ...
      . '  tx_org_staff,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.div_pubtrans,'
      ...
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.div_embedded,'
      . '  embeddedcode,'
  ...
  'palettes' => array(
    ...
    'mailaddress' => array(
      'showitem' => ''
      . 'mail_address;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_address,--linebreak--,'
      . 'mail_street;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_street,--linebreak--,'
      . 'mail_postcode;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_postcode,'
      . 'mail_city;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_city,--linebreak--,'
      . 'mail_country;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_country,',
      'canNotCollapse' => 1,
    ),
    'maillatlon' => array(
      'showitem' => ''
      . 'geoupdateprompt;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.geoupdateprompt,--linebreak--,'
      . 'geoupdateforbidden;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.geoupdateforbidden,--linebreak--,'
      . 'mail_lat;LLL:EXT:org/tca/locallang/tx_org_location.xml:tx_org_location.mail_lat,'
