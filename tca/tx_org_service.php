      ...
      'config' => array(
        ...
        'items' => array(
          'record' => array(
            ...
            '1' => 'record',
            '2' => 'EXT:org/ext_icon/service.gif',
          ),
          'page' => array(
...
//      'l10n_mode' => 'exclude',
    ...
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.title',
    ...
    'reference_number' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.reference_number',
      'config' => array(
        'type' => 'input',
        'size' => '30',
      )
    ...
    'description' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.description',
      'config' => array(
        'type' => 'text',
        'cols' => '30',
        'rows' => '5',
    ...
    'mail_address' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_address',
      'config' => $conf_text_30_05,
    ),
    'mail_street' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_street',
      'config' => array(
        'type' => 'input',
        'size' => '60',
        'eval' => 'trim'
    ...
    'mail_zip' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_zip',
      'config' => array(
        'type' => 'input',
        'size' => '20',
        'eval' => 'trim'
    ...
    'mail_city' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_city',
      'config' => array(
        'type' => 'input',
        'size' => '40',
        'eval' => 'trim'
    ...
    'mail_country' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_country',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'mail_lat' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_lat',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'mail_lon' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_lon',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'geoupdateprompt' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.geoupdateprompt',
      'config' => $conf_text_50_10,
    ),
    'geoupdateforbidden' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.geoupdateforbidden',
      'config' => array(
        'type' => 'check',
        'default' => '0'
      )
    ...
    'teaser_title' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.teaser_title',
      'config' => $conf_input_30_trim,
    ),
    'teaser_short' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.teaser_short',
      'config' => $conf_text_50_10,
    ),
    'marginal_title' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.marginal_title',
      'config' => $conf_input_30_trim,
    ),
    'marginal_short' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.marginal_short',
      'config' => $conf_text_50_10,
    ),
    'tx_org_servicecat' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.tx_org_servicecat',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicecat.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicecat.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_servicecat',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicecat.edit',
    ...
    'tx_org_servicesector' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.tx_org_servicesector',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicesector.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicesector.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_servicesector',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicesector.edit',
            'script' => 'wizard_edit.php',
            'popup_onlyOpenIfSelected' => 1,
            'icon' => 'edit2.gif',
            'JSopenParams' => 'height=350,width=580,status=0,menubar=0,scrollbars=1',
    ...
    'tx_org_servicetargetgroup' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.tx_org_servicetargetgroup',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicetargetgroup.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicetargetgroup.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_servicetargetgroup',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:wizard.tx_org_servicetargetgroup.edit',
            'script' => 'wizard_edit.php',
            'popup_onlyOpenIfSelected' => 1,
            'icon' => 'edit2.gif',
            'JSopenParams' => 'height=350,width=580,status=0,menubar=0,scrollbars=1',
    ...
    'tx_org_headquarters' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.tx_org_headquarters',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_staff' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.tx_org_staff',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    ...
    'record' => array(
      'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_service, '
      . '  type,'
      . '  --palette--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.palette_title;title, '
      . '  description;;;richtext[]:rte_transform[mode=ts],'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_categories,'
      . '  tx_org_servicecat,tx_org_servicesector,tx_org_servicetargetgroup,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_teaser,'
      . '  teaser_title,teaser_short,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_marginal,'
      . '  marginal_title,marginal_short,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_mail, '
      . '  --palette--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.palette_mailaddress;mailaddress, '
      . '  --palette--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.palette_maillatlon;maillatlon, '
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_company,'
      . '  tx_org_headquarters,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_staff,'
      . '  tx_org_staff,'
      ...
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_control,'
      . '  hidden;;control;;,fe_group,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.div_seo,'
  ...
  'palettes' => array(
    ...
    'mailaddress' => array(
      'showitem' => ''
      . 'mail_address;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_address,--linebreak--,'
      . 'mail_street;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_street,--linebreak--,'
      . 'mail_zip;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_zip,'
      . 'mail_city;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_city,--linebreak--,'
      . 'mail_country;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_country,',
      'canNotCollapse' => 1,
    ),
    'maillatlon' => array(
      'showitem' => ''
      . 'geoupdateprompt;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.geoupdateprompt,--linebreak--,'
      . 'geoupdateforbidden;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.geoupdateforbidden,--linebreak--,'
      . 'mail_lat;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_lat,'
      . 'mail_lon;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.mail_lon,',
      'canNotCollapse' => 1,
    ),
    'title' => array(
      'showitem' => ''
      . 'title;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.title,'
      . 'reference_number;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_service.reference_number'
      ,
      'canNotCollapse' => 1,
    ),
    'typepage' => array(
...
$TCA[ 'tx_org_servicecat' ] = array(
  ...
  'columns' => array(
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required,trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
    ...
    'icons' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.icons',
      'config' => $conf_file_image,
    ),
    'icon_offset_x' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.icon_offset_x',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
    ...
    'icon_offset_y' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.icon_offset_y',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
  ...
  'types' => array(
    '0' => array(
      'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.div_category,'
      . '  title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.div_icons,'
      . '  icons,icon_offset_x,icon_offset_y,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicecat.div_control,'
      . '  hidden'
    ,
    ),
  ),
...
$TCA[ 'tx_org_servicesector' ] = array(
  ...
  'columns' => array(
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required,trim',
    ...
    'title_lang_ol' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.title_lang_ol',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
    ...
    'icons' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.icons',
      'config' => $conf_file_image,
    ),
    'icon_offset_x' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.icon_offset_x',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
    ...
    'icon_offset_y' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.icon_offset_y',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
  ...
  'types' => array(
    '0' => array(
      'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.div_sector,'
      . '  title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.div_icons,'
      . '  icons,icon_offset_x,icon_offset_y,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicesector.div_control,'
      . '  hidden'
    ,
    ),
  ),
...
$TCA[ 'tx_org_servicetargetgroup' ] = array(
  ...
  'columns' => array(
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.title',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'required,trim',
    ...
    'title_lang_ol' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.title_lang_ol',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
    ...
    'icons' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.icons',
      'config' => $conf_file_image,
    ),
    'icon_offset_x' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.icon_offset_x',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
    ...
    'icon_offset_y' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.icon_offset_y',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
  ...
  'types' => array(
    '0' => array(
      'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.div_targetgroup,'
      . '  title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.div_icons,'
      . '  icons,icon_offset_x,icon_offset_y,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_service.xml:tx_org_servicetargetgroup.div_control,'
      . '  hidden'
    ,
    ),
  ),
