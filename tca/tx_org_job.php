...
//      'l10n_mode' => 'exclude',
    ...
    'title' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.title',
    ...
    'reference_number' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.reference_number',
      'config' => array(
        'type' => 'input',
        'size' => '30',
      )
    ...
    'quantity' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.quantity',
      'config' => array(
        'type' => 'input',
        'size' => '3',
    ...
    'description' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.description',
      'config' => array(
        'type' => 'text',
        'cols' => '30',
        'rows' => '5',
    ...
    'specification' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.specification',
      'config' => array(
        'type' => 'text',
        'cols' => '30',
        'rows' => '5',
    ...
    'mail_street' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_street',
      'config' => array(
        'type' => 'input',
        'size' => '60',
        'eval' => 'trim'
    ...
    'mail_zip' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_zip',
      'config' => array(
        'type' => 'input',
        'size' => '20',
        'eval' => 'trim'
    ...
    'mail_city' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_city',
      'config' => array(
        'type' => 'input',
        'size' => '40',
        'eval' => 'trim'
    ...
    'mail_country' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_country',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'mail_lat' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_lat',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'mail_lon' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_lon',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim'
    ...
    'geoupdateprompt' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.geoupdateprompt',
      'config' => $conf_text_50_10,
    ),
    'geoupdateforbidden' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.geoupdateforbidden',
      'config' => array(
        'type' => 'check',
        'default' => '0'
      )
    ...
    'teaser_title' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.teaser_title',
      'config' => $conf_input_30_trim,
    ),
    'teaser_short' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.teaser_short',
      'config' => $conf_text_50_10,
    ),
    'marginal_title' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.marginal_title',
      'config' => $conf_input_30_trim,
    ),
    'marginal_short' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.marginal_short',
      'config' => $conf_text_50_10,
    ),
    ...
    'onlineapplication' => array(
      'exclude' => $bool_exclude_default,
      'l10n_mode' => 'prefixLangTitle',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.onlineapplication',
      'config' => array(
        'type' => 'check'
      ),
    ),
    ...
    'tx_org_jobcat' => array(
      'l10n_mode' => 'exclude',
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.tx_org_jobcat',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobcat.add',
            'icon' => 'add.gif',
            'params' => array(
              'table' => 'tx_org_jobcat',
              'pid' => '###CURRENT_PID###',
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobcat.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_jobcat',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobcat.edit',
    ...
    'tx_org_jobsector' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.tx_org_jobsector',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobsector.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobsector.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_jobsector',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobsector.edit',
            'script' => 'wizard_edit.php',
            'popup_onlyOpenIfSelected' => 1,
            'icon' => 'edit2.gif',
            'JSopenParams' => 'height=350,width=580,status=0,menubar=0,scrollbars=1',
    ...
    'tx_org_jobworkinghours' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.tx_org_jobworkinghours',
      'config' => array(
        'type' => 'select',
        'size' => 10,
        'minitems' => 0,
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobworkinghours.add',
            'icon' => 'add.gif',
            'params' => array(
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobworkinghours.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_jobworkinghours',
              'pid' => '###CURRENT_PID###',
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:wizard.tx_org_jobworkinghours.edit',
            'script' => 'wizard_edit.php',
            'popup_onlyOpenIfSelected' => 1,
            'icon' => 'edit2.gif',
            'JSopenParams' => 'height=350,width=580,status=0,menubar=0,scrollbars=1',
    ...
    'tx_org_headquarters' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.tx_org_headquarters',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
    ...
    'tx_org_staff' => array(
      ...
      'exclude' => 0,
      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.tx_org_staff',
      'config' => array(
        'type' => 'select',
        'size' => 20,
        'minitems' => 0,
...
//      'l10n_mode' => 'exclude',
  ...
  'palettes' => array(
    ...
    'mailaddress' => array(
      ...
      . 'mail_country;LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_country,',
      'canNotCollapse' => 1,
    ),
    'maillatlon' => array(
      'showitem' => ''
      . 'geoupdateprompt;LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.geoupdateprompt,--linebreak--,'
      . 'geoupdateforbidden;LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.geoupdateforbidden,--linebreak--,'
      . 'mail_lat;LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_lat,'
      . 'mail_lon;LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_job.mail_lon,',
      'canNotCollapse' => 1,
    ),
    'reference_number' => array(
      'showitem' => ''
...
$TCA['tx_org_jobcat'] = array(
  ...
  'columns' => array(
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobcat.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
...
$TCA['tx_org_jobsector'] = array(
  ...
  'columns' => array(
    ...
    'title_lang_ol' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobsector.title_lang_ol',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobsector.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
...
$TCA['tx_org_jobworkinghours'] = array(
  ...
  'columns' => array(
    ...
    'title_lang_ol' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobworkinghours.title_lang_ol',
      'config' => array(
        'type' => 'input',
        'size' => '30',
        'eval' => 'trim',
    ...
    'uid_parent' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_job.xml:tx_org_jobworkinghours.uid_parent',
      'config' => array(
        'type' => 'select',
        'form_type' => 'user',
        'userFunc' => 'tx_cpstcatree->getTree',
