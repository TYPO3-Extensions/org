...
$TCA[ 'tx_org_cal' ] = array(
  ...
  'columns' => array(
    ...
    'page' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.page',
//      'l10n_mode' => 'mergeIfNotBlank',
    ...
    'url' => array(
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.url',
//      'l10n_mode' => 'mergeIfNotBlank',
      'exclude' => $bool_exclude_default,
      'config' => array(
        'type' => 'input',
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    ...
    'page' => array( 'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.div_calendar,'
      . '  --palette--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.palette_typepage;typepage,'
    ...
    'url' => array( 'showitem' => ''
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.div_calendar,'
      . '  --palette--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.palette_typeurl;typeurl,'
      . '  title,subtitle,datetime,tx_org_caltype,bodytext;;;richtext[]:rte_transform[mode=ts];,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.div_teaser,      teaser_title,teaser_subtitle,teaser_short,' .
      '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.div_marginal,    marginal_title,marginal_subtitle,marginal_short,' .
      '--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.images,' .
  ...
  'palettes' => array(
    ...
    'typepage' => array(
      'showitem' => ''
      . 'type;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.type,'
      . 'page;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.page'
      ,
      'canNotCollapse' => 1,
    ),
    'typeurl' => array(
      'showitem' => ''
      . 'type;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.type,'
      . 'url;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_cal.url'
      ,
      'canNotCollapse' => 1,
    ),
  ),
...
$TCA[ 'tx_org_caltype' ] = array(
  ...
  'columns' => array(
    'icons' => array(
      'exclude' => $bool_exclude_default,
//      'l10n_mode' => 'exclude',
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_caltype.icons',
      'config' => $conf_file_image,
    ),
    'icon_offset_x' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_caltype.icon_offset_x',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
    ...
    'icon_offset_y' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_caltype.icon_offset_y',
      'config' => array(
        'type' => 'input',
        'size' => '3',
        'max' => '3',
...
//        'foreign_table_where' => 'AND tx_org_cal.' . $str_store_record_conf . ' AND tx_org_cal.deleted = 0 AND tx_org_cal.hidden = 0 AND tx_org_cal.sys_language_uid=###REC_FIELD_sys_language_uid### ORDER BY tx_org_cal.datetime DESC, title',
  ...
  'types' => array(
    '0' => array( 'showitem' => '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_caltype.div_caltype,    title;;1;;,uid_parent,'
      . '--div--;LLL:EXT:org/tca/locallang/tx_org_cal.xml:tx_org_caltype.div_icons,'
      . '  icons,icon_offset_x,icon_offset_y,'
