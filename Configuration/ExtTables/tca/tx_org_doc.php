...
$TCA['tx_org_downloads'] = array(
  'ctrl' => array(
    ...
    'thumbnail' => 'image',
    'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Configuration/ExtIcon/download.gif',
    'type' => 'type',
    'typeicon_column' => 'type',
    'typeicons' => array(
      'download' => '../typo3conf/ext/org/Configuration/ExtIcon/download.gif',
      'download_shipping' => '../typo3conf/ext/org/Configuration/ExtIcon/download_shipping.gif',
      'shipping' => '../typo3conf/ext/org/Configuration/ExtIcon/shipping.gif',
    ),
    'searchFields' => ''
