...
$TCA[ 'tx_org_news' ] = array(
  'ctrl' => array(
    ...
    'thumbnail' => 'image',
    'iconfile' => t3lib_extMgm::extRelPath( $_EXTKEY ) . 'Configuration/ExtIcon/news.gif',
    'type' => 'type',
    'typeicon_column' => 'type',
    'typeicons' => array(
      'record' => '../typo3conf/ext/org/Configuration/ExtIcon/news.gif',
      ...
      'news' => '../typo3conf/ext/org/Configuration/ExtIcon/news.gif',
      'page' => '../typo3conf/ext/org/Configuration/ExtIcon/page.gif',
      'url' => '../typo3conf/ext/org/Configuration/ExtIcon/url.gif',
    ),
