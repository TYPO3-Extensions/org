...
$TCA['tx_org_headquarters'] = array(
  'ctrl' => array(
    ...
    'thumbnail' => 'image',
    'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Configuration/ExtIcon/headquarters.gif',
    // #58884, 140516, dwildt, 1+
    'treeParentField' => 'uid_parent',
    'type'              => 'type',
    'typeicon_column'   => 'type',
    'typeicons'         => array(
      'record'  => '../typo3conf/ext/org/Configuration/ExtIcon/headquarters.gif',
...
$TCA['tx_org_headquarterscat'] = array(
  'ctrl' => array(
    ...
    'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY) . 'tca.php',
    'thumbnail' => 'icons',
    'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Configuration/ExtIcon/headquarterscat.gif',
