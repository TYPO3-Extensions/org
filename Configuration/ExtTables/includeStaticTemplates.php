...
switch( true )
{
  case($llStatic == 'de'):
    ...
    t3lib_extMgm::addStaticFile($_EXTKEY,'Configuration/TypoScript/staff/vCard/120/',                 'Org [6] Personen vCard');
  ...
  default:
    ...
    t3lib_extMgm::addStaticFile($_EXTKEY,'Configuration/TypoScript/staff/vCard/120/',                 'Org [9] People vCard');
