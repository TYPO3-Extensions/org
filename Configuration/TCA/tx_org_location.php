...
return array(
  'ctrl' => array(
    ...
    'hideAtCopy' => true,
    'thumbnail' => 'image',
    'iconfile' => t3lib_extMgm::extRelPath( $_EXTKEY ) . 'Resources/Public/Images/Icons/ExtIcon/location.gif',
    'type' => 'type',
    'typeicon_column' => 'type',
    'typeicons' => array(
      'record' => '../typo3conf/ext/org/Resources/Public/Images/Icons/ExtIcon/location.gif',
      ...
      'config' => array(
        ...
        'items' => array(
          'record' => array(
            ...
            '1' => 'record',
            '2' => 'EXT:org/Resources/Public/Images/Icons/ExtIcon/location.gif',
          ),
          'page' => array(
...
//      'l10n_mode' => 'exclude',
    ...
    'mail_city' => array(
      ...
      'config_filter' => array(
        ...
        'size' => 1,
        'foreign_table' => 'tx_org_location',
        'foreign_table_where' => 'AND tx_org_location.deleted = 0 AND tx_org_location.hidden = 0 ORDER BY tx_org_location.mail_city',
        'items' => array(
          'empty' => array(
            '0' => '',
            '1' => '',
...
//        'MM' => 'tx_org_cal_mm_tx_org_location',
        ...
        'wizards' => array(
          ...
          'add' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/Resources/Private/Language/locallang_db.xml:wizard.tx_org_cal.add',
            'icon' => 'add.gif',
            'params' => array(
              'table' => 'tx_org_cal',
              'pid' => $str_marker_pid,
          ...
          'list' => array(
            'type' => 'script',
            'title' => 'LLL:EXT:org/Resources/Private/Language/locallang_db.xml:wizard.tx_org_cal.list',
            'icon' => 'list.gif',
            'params' => array(
              'table' => 'tx_org_cal',
              'pid' => $str_marker_pid,
          ...
          'edit' => array(
            'type' => 'popup',
            'title' => 'LLL:EXT:org/Resources/Private/Language/locallang_db.xml:wizard.tx_org_cal.edit',
...
//      'l10n_mode' => 'exclude',
  ...
  'types' => array(
    ...
    'notype' => array( 'showitem' => ''
      ...
      . '  --palette--;LLL:EXT:org/Resources/Private/Language/locallang_db.xml:palette_typerecord;typerecord,'
