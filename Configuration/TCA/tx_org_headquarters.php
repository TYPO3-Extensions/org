...
return array(
  'ctrl' => array(
    ...
    'hideAtCopy' => true,
    'thumbnail' => 'image',
    'iconfile' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Images/Icons/ExtIcon/headquarters.gif',
    // #58884, 140516, dwildt, 1+
    'treeParentField' => 'uid_parent',
    'type'              => 'type',
    'typeicon_column'   => 'type',
    'typeicons'         => array(
      'record'  => '../typo3conf/ext/org/Resources/Public/Images/Icons/ExtIcon/headquarters.gif',
      ...
      'config' => array(
        ...
        'items' => array(
          'record' => array(
            ...
            '1' => 'record',
            '2' => 'EXT:org/Resources/Public/Images/Icons/ExtIcon/headquarters.gif',
          ),
          'page' => array(
...
//      'l10n_mode' => 'exclude',
    ...
    'uid_parent' => array(
      ...
      'config' => array(
        ...
        'foreign_table_where' => ''
        // 151028, dwildt+/-: nor records visible, probably of no support in user_func for ###PAGE_TSCONFIG_IDLIST###
        //. 'AND tx_org_headquarters.' . $str_store_record_conf . ' '
