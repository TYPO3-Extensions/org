plugin.org {
  ...
  frontendediting {
    tx_org_job {
      # cat=Organiser - Filter: Jobs/enable/101;      type=string; label=type=string; label= allowed:List of fields, which are allowed for editing
      allowed   = applicationaddress, applicationurl, dateofentry, description, documents, documents_from_path, documentscaption, documentslayout, documentssize, image, image_compression, image_effects, image_frames, image_link, image_noRows, image_zoom, imageborder, imagecaption, imagecaption_position, imagecols, imageheight, imageorient, imageseo, imagewidth, mail_address, mail_city, mail_country, mail_lat, mail_lon, mail_street, mail_zip, marginal_short, marginal_title, newsletter, onlineapplication, quantity, reference_number, seo_description, seo_keywords, specification, teaser_short, teaser_title, title, tx_org_headquarters, tx_org_jobcat, tx_org_jobsector, tx_org_jobworkinghours, tx_org_staff, type, url
      # cat=Organiser - Filter: Jobs/enable/999;      type=user[EXT:org/lib/userfunc/class.tx_org_userfunc.php:tx_org_userfunc->promptSponsors]; label=Subsidise the TYPO3-Organiser!
      externalSponsors    = Click me!
    }
  }
