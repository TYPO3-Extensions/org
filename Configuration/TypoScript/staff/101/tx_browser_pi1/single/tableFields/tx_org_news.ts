      ...
      101 {
        tx_org_staff {
          crdate {
            ...
            // tx_org_staff.crdate: placeholder for tx_org_news
          crdate = COA
          crdate {
              ...
              20 {
                ...
                select {
                  ...
                  where {
                    ...
                    noTrimWrap = |tx_org_mm_all.uid_foreign = | AND tx_org_mm_all.table_foreign = 'tx_org_staff' AND tx_org_mm_all.table_local = 'tx_org_news'|
                  }
